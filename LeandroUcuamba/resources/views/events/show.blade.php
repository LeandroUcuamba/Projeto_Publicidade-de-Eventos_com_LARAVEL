    ...
    <div class="row">
      <div id="image-container" class="col-md-6">
       ...
       <div id="info-container" class="col-md-6">
         ...
         <p class="events-participants"><span class="mdi mdi-human-queue"></span> {{ count($event->users) }} participantes</p>
         <p class="events-owner"><span class="mdi mdi-handshake"></span> {{ $eventOwner['name'] }}</p>
         @if(!$hasUserJoined)
